...
import edu.pitt.dbmi.causal.compare.util.JAXBUtils;
...
public final class CmdParser {
    ...
    private static void parseRequiredOptions(CommandLine cmd, Options options, CmdArgs cmdArgs) throws CmdParserException {
        ...
        try {
            cmdArgs.configuration = (ComparisonConfiguration) JAXBUtils.read(configFile, ComparisonConfiguration.class);
